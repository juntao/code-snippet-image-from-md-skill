...
# Clone the skill
git clone --depth 1 https://github.com/juntao/code-snippet-image-from-md-skill.git /tmp/code-snippet-images-repo
...
1. Go to https://github.com/juntao/code-snippet-image-from-md-skill/releases/latest
...
```bash
curl -I "https://github.com/juntao/code-snippet-image-from-md-skill/releases/latest"
```
